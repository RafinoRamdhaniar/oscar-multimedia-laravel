        ...
        <div class="col-lg-3 d-none d-lg-block">
            ...
            <div class="product-card tall-card position-relative overflow-hidden">
                ...
                <div class="overlay position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <a href="https://wa.me/628112890087?text=Halo, saya ingin membeli produk: {{ urlencode($product->nama_produk) }}" target="_blank" class="btn mt-2" style= "background-color: #e8b535; color: #fff;">Klik Disini</a>
                </div>
            </div>
        </div>
