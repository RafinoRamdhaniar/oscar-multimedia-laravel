        ...
        <div class="col-lg-3 d-none d-lg-block">
            ...
            <div class="product-card tall-card position-relative overflow-hidden">
                ...
                <div class="overlay position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <a href="https://wa.me/628112890087?text=Halo, saya ingin membeli produk: {{ urlencode($product->nama_produk) }}" target="_blank" class="btn mt-2" style= "background-color: #e8b535; color: #fff;">Pesan via WhatsApp</a>
                </div>
            </div>
        </div>
                ...
                @for ($i = 1; $i <= 4; $i++)
                    ...
                    <div class="col-6">
                        <div class="product-card small-card position-relative overflow-hidden">
                            ...
                            <div class="overlay position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center align-items-center">
                                <h4 class="text-white fw-bold text-center">{{ $product->nama_produk }}</h4>
                                <a href="https://wa.me/6287708259500?text=Halo, saya ingin membeli produk: {{ urlencode($product->nama_produk) }}" target="_blank" class="btn mt-2" style= "background-color: #e8b535; color: #fff;">Pesan via WhatsApp</a>
                            </div>
                        </div>
                    </div>
                @endfor
